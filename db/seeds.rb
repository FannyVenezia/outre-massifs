...
hikeAlpilles.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeAlpilles.save
...
hikeMontmirail.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeMontmirail.save
...
hikeVentoux.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeVentoux.save
...
hikeBivouac.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeBivouac.save
...
hikeSoleil.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeSoleil.save
...
hikeVaucluse.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeVaucluse.save
...
hikeNesque.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeNesque.save
...
hikeVenasque.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeVenasque.save
...
hikeBeaucet = Hike.new(title: "Le Beaucet", description: "Accroché à la roche, le village se blottit à l'ombre de son Château
  ...
  au programme.")
hikeBeaucet.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeBeaucet.save
...
hikeLuberon.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeLuberon.save
...
hikeOppede = Hike.new(title: "Oppède-le-Vieux", description: "Oppède est certainement l'un des villages les plus authentiques et
  ...
  perchés alentours...")
hikeOppede.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeOppede.save
...
hikeSenanque.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeSenanque.save
...
hikeAiguebrun = Hike.new(title: "Le vallon de l'aiguebrun et les falaises de Buoux", description: "Une petite balade dans l’intimité du Luberon, dans la fraîcheur
  ...
  montagne")
hikeAiguebrun.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeAiguebrun.save
...
hikeRustrel = Hike.new(title: "Les Ocres de Rustrel", description: "Il y a plus de deux cent millions d’années, la Provence était recouverte par
  ...
  ")
hikeRustrel.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alpilles.jpg')), filename: 'avatar.jpg')
hikeRustrel.save
